...
WHERE dbms_lob.instr(LOWER(DOC.X_LOCATION_LOB), LOWER('\SG1473P\')) > 0
;
UPDATE BSI_DOCUMENT SET X_LOCATION_LOB = REPLACE(dbms_lob.substr(X_LOCATION_LOB, 1000, 1), '\SG1473P\', '\NX01\')
;

UPDATE BSI_DOCUMENT doc SET X_LOCATION_LOB = REPLACE(dbms_lob.substr(DOC.X_LOCATION_LOB, 1000, 1), '\SG1473P\', '\NX01\')
WHERE DOC.DOCUMENT_NR = 65776232
;
COMMIT;
