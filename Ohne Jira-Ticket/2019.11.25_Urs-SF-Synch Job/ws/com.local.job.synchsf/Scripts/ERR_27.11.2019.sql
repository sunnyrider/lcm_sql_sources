...
SELECT LE.X_COMPLEX_NO FROM BSI_LEGAL_ENTITY_VIEW le WHERE LE.COMPANY_NR = 4089672869
;
SELECT CMP.X_COMPLEX_NO FROM BSI_COMPANY cmp WHERE CMP.COMPANY_NR = 4089672869
;
...
-- Test auf TEP
--
SELECT * FROM BSI_X_REST_SYNC_ITEM rsi WHERE RSI.ROOT_ITEM_KEY0_NR = '4089672869'
;
SELECT * FROM BSI_RECEIPT_CUST_BALANCE_MVIEW rcb WHERE RCB.COMPANY_NR = '4089672869' 
;
SELECT * FROM BSI_X_COMPLEX_PUBLISH xcp WHERE xcp.JOIN_NR = '4089672869'
;
