...
--			   		START WITH uc_uid = prd.type_uid)
			   AND COALESCE (
			   		(SELECT evt_conclusion 
			   			FROM bsi_x_ext_contract WHERE contract_nr = prd.contract_nr), prd.evt_product_start) 
...
/* Berechnung der verschiedenen Kriterien (Beschrieb der Stati --> LCM-1593)*/
cust_stats AS (
  	SELECT 
  		csc.join_nr,
...
--	customer_quadrant_start,
--	customer_quadrant_ende,
--	region_leader,
--	wert_start,
	wert_ende
--
