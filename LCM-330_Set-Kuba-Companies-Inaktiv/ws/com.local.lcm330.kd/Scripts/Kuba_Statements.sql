...
INSERT INTO BSICRM_EXT.BSI_X_KUBA_DATA_JOIN bkd (BKD.BSI_X_EXT_JOIN__JOIN_NO)
	...
	WHERE EJ.INTERFACE_UID NOT IN (108187, 108205) -- samba / nxdsmp, Küba: 131309
	AND EJ.ACTIVE = 1
;
...
-- ------------------------------------------
-- Zurücksetzen der Küba Daten auf ACTIVE = 1
-- ------------------------------------------
--
-- Zum Zurücksetzen des ACTIVE = 1 Zustandes 
-- für alle Küba Daten kann der folgende 
