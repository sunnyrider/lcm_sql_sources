...
--	WHERE X_COMMUNICATION_EXT_KEY = '4E58F6EB19453B9BE053C020A60A06E7'
	...
	SELECT 
		PSL.lob_length,
		LENGTH(PSL.LCM_Communcation_Text_Part1) len_p1,
		LENGTH(PSL.LCM_Communcation_Text_Part2) len_p2,
...
--	CMC.TEXT_LOB,
	...
	REPLACE(REPLACE(dbms_lob.substr(to_clob(CMC.TEXT_LOB), 3000, 3001), CHR(10), ' '), chr(11), ' ') part2
FROM BSI_COMMUNICATION CMC
...
WHERE X_COMMUNICATION_EXT_KEY = '38A18B59B4756BF5E053C020A60A91BB'
;