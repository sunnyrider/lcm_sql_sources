SELECT XCR.VALUE_LONG FROM BSICRM_EXT.EXT_COMMUNICATION_REACTION xcr
--WHERE XCR.COMMUNICATION_EXT_KEY = KUNDENFEEDBACK.COMMUNICATION_EXT_KEY 
WHERE UPPER(REACTION) = UPPER('PERSON_REQUIREMENTCATCHED') AND ROWNUM = 1
;
